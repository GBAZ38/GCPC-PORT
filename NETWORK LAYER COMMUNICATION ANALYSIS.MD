...
In this activity, we analyze DNS and ICMP traffic in transit using data from a network protocol analyzer tool. We identify which network protocol was utilized in assessment of the cybersecurity incident.<br>
...
Knowing how to identify potentially malicious traffic on a network can help cybersecurity analysts assess security risks on a network and reinforce network security.<br>
